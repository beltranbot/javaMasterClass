...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        result = result % 3; // th remainder of (4 % 3) = 1
        ...
        double remainder = myDoubleTotal % 40.00;
        System.out.println("remainder = " + remainder);
        boolean myBooleanResult = remainder == 0;
        System.out.println("myBooleanResult = " + myBooleanResult);
        if (!myBooleanResult) {
