public class MainChallenge {
    ...
    * number of items.
    *
    * You will need to add a "reserved" field to teh StockItem class to store the
    ...
    *
    * Add code to Main that will unreserve items after t hey have been added to the basket,
