public class SetChallenge {
     ...
     * type of HeavenlyBody (such as STAR, PLANT, MOON, etc).
     *
     * You can include as many types as you want, but must support at
     * least PLANET and MOON.
     *
     * For each of the types that you support, subclass the HeavenlyBody class
     * so that your program can create object of the appropriate type.
     *
     ...
     * same type of body: so you could have a start called "BetaMinor" and
     ...
     *
     * 4. Attempting to add a dupolicate to a Map results in the original being replaced
     * by the new object.
     *
