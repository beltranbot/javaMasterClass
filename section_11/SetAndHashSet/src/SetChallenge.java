public class SetChallenge {
    ...
    *
    * For each of the types that yo usupport, subclass the HeavenlyBody class
    * so that your program can create objects of the appropiate type.
    ...
    * same type of body: so you could have a star called "BetaMino" and
    * an asteroid also called "BetaMinor", for example.
    *
    * Hint: This is much easier to implement for the Set than it is for the Map,
    * beacuse the Map will need a key that uses both fields.
    *
    * There is a restriction that the only satellites taht planets can have must
    * bwe moons. Even if you don't implement a START type, though, your program
    * should not preven one benig added in the future (and a STAR's satellites
    * can be almost every kind of HeavenlyBody ).
    *
    * Test cases:
    * 1. The planets and moons that we added in the previous video should appear in
    * the solarSystem collection and in the sets of moons for the appropiate planets.
    *
    * 2. a.equals(b) must return the same result as b.equals(a) - equals is symmetric.
    *
    * 3. Attempting to add a duplicate to a Set must result in no change to the set (so
    * the original value is not replace by the new one)
    *
    ...
    *
    * 6. Two bodies wit hteh same name but different designation can be added to the same map,
