public class Main {
    ...
    * the parameter and less than 0 if it sorts less than the parameter.
    *
    ...
    * alphabetically). Duplicated values are not added.
    *
    ...
    *   again (if here is no next item then that is where the new item belongs).
    *
    ...
    * as LinkedList) then it will create imports for them and possibly cause problems later.
    *
    ...
    *
    * The new item is added when an attemp to move in the required direction would involve following a
    * null reference.
    * Once again, duplicates are not allowed.
    *
    * Hint: to avoid typing loads of "addItem" lines, split a string into an arary and create your list
